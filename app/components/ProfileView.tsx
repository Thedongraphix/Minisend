      ...
      {allOrders.length > 0 && !selectedDate && (
        <div className="glass-effect rounded-3xl p-6 sm:p-8">
          <div className="flex items-center justify-between mb-4 sm:mb-6">
            <h3 className="text-white font-bold text-base sm:text-lg">All Transactions</h3>
            <button
              onClick={fetchLatestStatuses}
            ...
            >
              ...
              <span className="text-xs font-medium text-blue-400">Refresh</span>
            </button>
          </div>

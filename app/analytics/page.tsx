      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <div className="border border-gray-800/50 rounded-2xl p-6 bg-[#111]">
            <h3 className="text-lg font-medium text-white mb-4">KES Revenue</h3>
            <div className="space-y-3">
              <div className="flex justify-between">
                <span className="text-gray-400">Total</span>
                <span className="text-white font-medium">${analyticsData.summary.revenueByCurrency.KES.total.toFixed(4)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-400">Transactions</span>
                <span className="text-white font-medium">{analyticsData.summary.revenueByCurrency.KES.count}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-400">Avg Fee</span>
                <span className="text-white font-medium">${analyticsData.summary.revenueByCurrency.KES.avgFee.toFixed(4)}</span>
              </div>
            </div>
          </div>

          <div className="border border-gray-800/50 rounded-2xl p-6 bg-[#111]">
            <h3 className="text-lg font-medium text-white mb-4">NGN Revenue</h3>
            <div className="space-y-3">
              <div className="flex justify-between">
                <span className="text-gray-400">Total</span>
                <span className="text-white font-medium">${analyticsData.summary.revenueByCurrency.NGN.total.toFixed(4)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-400">Transactions</span>
                <span className="text-white font-medium">{analyticsData.summary.revenueByCurrency.NGN.count}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-400">Avg Fee</span>
                <span className="text-white font-medium">${analyticsData.summary.revenueByCurrency.NGN.avgFee.toFixed(4)}</span>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="px-3 py-1 bg-gray-900 hover:bg-gray-800 disabled:bg-gray-900/50 disabled:cursor-not-allowed border border-gray-800 rounded text-sm"
                    >
                      Previous
                    </button>
                    <button
    ...
    <div className="border border-gray-800/50 rounded-2xl p-6 bg-[#111]">
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          ...
          {growth !== undefined && (
            <div className={`flex items-center gap-1 text-xs ${growth > 0 ? 'text-green-400' : growth < 0 ? 'text-red-400' : 'text-gray-500'}`}>
              {growth > 0 && (
                <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">

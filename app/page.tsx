      ...
      <div className="w-full max-w-md mx-auto px-4 mb-4">
        <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-3 flex items-start space-x-3">
          ...
          <div className="flex-1">
            <p className="text-sm text-yellow-200 font-medium">We are currently undergoing maintenance for NGN txs and will be back before 15th Nov 6pm EAT.MPesa is fully operational</p>
          </div>
        </div>
      </div>

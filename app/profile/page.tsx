...
export default function ProfilePage() {
  ...
  }, [userWallet, loadAllUserTransactions]);
  ...
  const getTimezoneInfo = (currency?: string) => {
    switch (currency) {
      case 'NGN':
        return { timezone: 'Africa/Lagos', abbr: 'WAT' };
      case 'GHS':
        return { timezone: 'Africa/Accra', abbr: 'GMT' };
      case 'KES':
      default:
        return { timezone: 'Africa/Nairobi', abbr: 'EAT' };
    }
  };
      ...
      <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-6">
        <div className="max-w-md w-full text-center">
          <div className="mb-8">
            ...
            />
            <h1 className="text-2xl font-semibold text-white mb-2">Welcome to Minisend</h1>
            <p className="text-gray-400 text-sm">
              Sign in to view your profile and manage your wallet
            </p>
          </div>

          <button
            onClick={login}
            className="w-full py-3.5 px-6 bg-[#0052FF] hover:bg-[#0047e1] text-white font-semibold rounded-xl transition-colors"
          >
            Sign in with Email
          </button>

          <p className="mt-6 text-gray-500 text-xs">
            {platform === 'web' ? 'Powered by Privy' : `Platform: ${platform}`}
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-6">
        <div className="text-center">
          <div className="animate-spin rounded-full h-8 w-8 border-4 border-white/20 border-t-[#0052FF] mx-auto mb-4"></div>
      ...
      <div className="max-w-lg mx-auto px-4 py-8">
            ...
            <div className="flex items-center space-x-3 min-w-0 flex-1">
              <div className="relative flex-shrink-0">
                <Avatar
                  ...
                  chain={base}
                  className="h-14 w-14 ring-2 ring-[#0052FF]/30 rounded-full"
                />
              </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          <div className="bg-white/5 rounded-2xl p-4 border border-white/10">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-gray-400 text-xs font-semibold uppercase tracking-wide">Volume</span>
            </div>
            <p className="text-white text-2xl font-bold">${stats.totalVolumeUSDC.toFixed(2)}</p>
          </div>
          ...
          <div className="bg-white/5 rounded-2xl p-4 border border-white/10">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-gray-400 text-xs font-semibold uppercase tracking-wide">Balance</span>
            </div>
        ...
        {minisendWallet && (
          <button
            ...
            className="w-full bg-white/5 hover:bg-white/[0.07] border border-white/10 hover:border-white/20 rounded-2xl p-4 transition-all duration-200 mb-6"
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <div className="text-gray-400 text-xs">Up to 4 networks supported</div>
                </div>
              </div>
              <svg
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 rounded-full bg-white/10 p-1 flex items-center justify-center">
                  <Image src="/base-logo.png" alt="Base" width={14} height={14} />
                </div>
                <div className="w-6 h-6 rounded-full bg-white/10 p-0.5 flex items-center justify-center">
                  <Image src="/polygon-logo.png" alt="Polygon" width={14} height={14} />
                </div>
                <div className="w-6 h-6 rounded-full bg-white/10 p-0.5 flex items-center justify-center">
                  <Image src="/celo-logo.png" alt="Celo" width={14} height={14} />
                </div>
                <div className="w-6 h-6 rounded-full bg-white p-0.5 flex items-center justify-center">
                  <Image src="/lisk-logo.png" alt="Lisk" width={14} height={14} />
                </div>
              </div>
            </div>
          </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              disabled={refreshing}
              className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-[#0052FF]/10 hover:bg-[#0052FF]/20 border border-[#0052FF]/20 transition-colors disabled:opacity-50"
              title="Refresh"
            >
              {refreshing ? (
                <div className="w-3.5 h-3.5 border-2 border-[#0052FF] border-t-transparent rounded-full animate-spin"></div>
              ) : (
                <svg className="w-3.5 h-3.5 text-[#0052FF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                </svg>
              )}
              <span className="text-xs font-medium text-[#0052FF]">Refresh</span>
            </button>
          </div>
          ...
          {allOrders.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-400 text-sm">Start by depositing USDC to your wallet</p>
            </div>
          ) : viewAll ? (
            <div className="space-y-2">
              <button
                onClick={toggleViewAll}
                className="flex items-center gap-1 text-[#0052FF] hover:text-[#0047e1] transition-colors text-xs font-medium mb-3"
              >
              ...
              {allOrders.slice(0, displayLimit).map((order) => {
                ...
                return (
                  <div
                    key={order.id}
                    className="bg-white/5 rounded-2xl border border-white/10 overflow-hidden transition-all hover:bg-white/[0.07]"
                  >
                    <div
                        ...
                        <div className="flex items-center gap-2 flex-shrink-0">
                          ...
                          {isSuccess && !order.pretium_transaction_code && (
                            <button
                              ...
                              className="p-2 bg-purple-600 hover:bg-purple-700 rounded-xl transition-all"
              ...
              {allOrders.length > displayLimit && (
                <div className="text-center pt-3">
                  <button
                    ...
                    className="text-[#0052FF] hover:text-[#0047e1] text-xs font-medium"
                  >
                    Load More
                  </button>
            ...
            <div className="space-y-2">
              {transactionsByDate.slice(0, displayLimit / 4).map(({ date, orders }) => {
                ...
                return (
                  <div
                    ...
                    className="bg-white/5 hover:bg-white/[0.07] rounded-2xl p-3.5 border border-white/10 cursor-pointer transition-all duration-200 group"
                  >
                    <div className="flex items-center justify-between">
                      <div className="min-w-0 flex-1">
              ...
              <div className="text-center pt-3 border-t border-white/10 mt-4">
                <button
                  onClick={toggleViewAll}
                  className="text-[#0052FF] hover:text-[#0047e1] text-xs font-medium transition-colors"
                >

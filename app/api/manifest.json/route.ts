...
export async function GET() {
  const manifest = {
    ...
    frame: {
      ...
      imageUrl: process.env.NEXT_PUBLIC_IMAGE_URL || process.env.NEXT_PUBLIC_ICON_URL || "https://app.minisend.xyz/minisend-logo.png",
      ...
      heroImageUrl: process.env.NEXT_PUBLIC_APP_HERO_IMAGE || process.env.NEXT_PUBLIC_ICON_URL || "https://app.minisend.xyz/minisend-logo.png",
      ...
      ogImageUrl: process.env.NEXT_PUBLIC_APP_OG_IMAGE || process.env.NEXT_PUBLIC_ICON_URL || "https://app.minisend.xyz/minisend-logo.png",

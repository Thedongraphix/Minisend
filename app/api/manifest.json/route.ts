...
export async function GET() {
  const manifest = {
    ...
    frame: {
      ...
      homeUrl: process.env.NEXT_PUBLIC_APP_URL || "https://minisend.xyz", 
      imageUrl: process.env.NEXT_PUBLIC_IMAGE_URL || process.env.NEXT_PUBLIC_ICON_URL || "https://minisend.xyz/minisend-logo.png",
      ...
      webhookUrl: `${process.env.NEXT_PUBLIC_APP_URL || "https://minisend.xyz"}/api/webhooks`,
      ...
      screenshotUrls: process.env.NEXT_PUBLIC_SCREENSHOT_URLS 
        ...
        : [`${process.env.NEXT_PUBLIC_APP_URL || "https://minisend.xyz"}/screenshot.jpeg`],
      ...
      heroImageUrl: process.env.NEXT_PUBLIC_APP_HERO_IMAGE || process.env.NEXT_PUBLIC_ICON_URL || "https://minisend.xyz/minisend-logo.png",
      ...
      ogImageUrl: process.env.NEXT_PUBLIC_APP_OG_IMAGE || process.env.NEXT_PUBLIC_ICON_URL || "https://minisend.xyz/minisend-logo.png",
      castShareUrl: process.env.NEXT_PUBLIC_CAST_SHARE_URL || `${process.env.NEXT_PUBLIC_APP_URL || "https://minisend.xyz"}/share`
    }
  };

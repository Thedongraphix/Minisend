...
export async function GET() {
  ...
  const screenshots: string[] = process.env.NEXT_PUBLIC_SCREENSHOT_URLS 
    ...
    : [`${URL || "https://minisend.xyz"}/hero.png`];
  ...
  return Response.json({
    ...
    frame: withValidProperties({
      ...
      imageUrl: process.env.NEXT_PUBLIC_IMAGE_URL || "https://minisend.xyz/hero.png",
      ...
      heroImageUrl: process.env.NEXT_PUBLIC_APP_HERO_IMAGE || "https://minisend.xyz/hero.png",
      ...
      ogImageUrl: process.env.NEXT_PUBLIC_APP_OG_IMAGE || "https://minisend.xyz/hero.png",

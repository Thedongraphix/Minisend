...
export async function GET() {
  ...
  const screenshots: string[] = process.env.NEXT_PUBLIC_SCREENSHOT_URLS 
    ...
    : [`${URL || "https://minisend.xyz"}/screenshot.jpeg`];
  ...
  return Response.json({
    ...
    frame: withValidProperties({
      ...
      imageUrl: process.env.NEXT_PUBLIC_IMAGE_URL || process.env.NEXT_PUBLIC_ICON_URL || "https://minisend.xyz/screenshot.jpeg",
      ...
      ogImageUrl: process.env.NEXT_PUBLIC_APP_OG_IMAGE || process.env.NEXT_PUBLIC_ICON_URL || "https://minisend.xyz/screenshot.jpeg",
